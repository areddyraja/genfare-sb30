...
//         [newCardService execute];
        ...
        GetWalletsService * walletsService = [[GetWalletsService alloc] initWithListener:self nickname:@"" managedObjectContext:self.managedObjectContext uuid:[[[UIDevice currentDevice]identifierForVendor]UUIDString] personId:account.id];
        ...
        if ([cards count] > 0) {
            ...
            AssignCardService *assignCard = [[AssignCardService alloc] initWithListener:self
                                                                   managedObjectContext:self.managedObjectContext
                                                                            ...
                                                                            accoundUuid:loggedInAccount.uuid];
            [assignCard execute];
        }
        */
