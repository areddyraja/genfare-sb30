...
- (void)configureUserInterface
{
    ...
    if (_useMenuLikeSegmentedControl) {
        ...
        if (_centerMenuItems) {
            selectionIndicatorFrame = CGRectMake(_startingMenuMargin + _menuMargin, 8 , _menuItemWidth, _menuHeight - 16);
        } else {
            selectionIndicatorFrame = CGRectMake(_menuMargin, 8 , _menuItemWidth, _menuHeight - 16);
        }
    }
    
    _selectionIndicatorView = [[UIView alloc] initWithFrame:selectionIndicatorFrame];
    _selectionIndicatorView.layer.cornerRadius = 8;
