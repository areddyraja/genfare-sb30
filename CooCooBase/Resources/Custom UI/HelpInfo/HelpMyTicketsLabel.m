...
#import "HelpMyTicketsLabel.h"
#import "Utilities.h"
#import "UIColor+HexString.h"
#import "UILabel+Italicfy.h"

@implementation HelpMyTicketsLabel

- (void)awakeFromNib{
    [super awakeFromNib];
    [self setHelpMyTicketsText];
}
- (void)setHelpMyTicketsText{
    NSString * helpMyTicketsText = [NSString stringWithFormat:@"%@HelpMyTickets",[[Utilities tenantId] lowercaseString]];
    [self setText:[Utilities stringResourceForId:helpMyTicketsText]];
