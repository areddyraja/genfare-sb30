//
//  GFMapsHomeViewController.swift
//  CDTATicketing
//
//  Created by omniwzse on 11/10/18.
...
class GFMapsHomeViewController: GFBaseViewController, CLLocationManagerDelegate, MKMapViewDelegate, UITextFieldDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if !singleton.isAppOpened  {
            singleton.isAppOpened = true
            openSideMenu()
        }
    ...
    func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        //Check for reachability [[Reachability reachabilityForInternetConnection]currentReachabilityStatus]==NotReachable
        ...
        //push controller
        if let navController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "GFNAVIGATEHOME") as? GFNavigateViewController {
