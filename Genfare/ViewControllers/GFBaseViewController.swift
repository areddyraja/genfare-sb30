...
@objc class GFBaseViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //TODO - Need to uncomment this line to set logo
    ...
    @objc func showUserLogin(notification:Notification) {
        //TODO - Need to present login screen
...
//        present(navController, animated: true, completion: nil)
    ...
    func showAccountHome() {
        //TODO - need to implement this method to show home screen
        print("Show account Home")
