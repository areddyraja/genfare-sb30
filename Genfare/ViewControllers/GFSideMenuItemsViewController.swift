...
class GFSideMenuItemsViewController: UIViewController {
    ...
    @objc func navigateToAlerts() -> Void {
        ...
        //TODO - need to implement Alerts
        popupAlert(title: "Alerts", message: "Alerts is not available", actionTitles: ["OK"], actions:[nil])
    ...
    @objc func navigateToContactus() -> Void {
        ...
        //TODO - need to implement Contact Us
        popupAlert(title: "Help", message: "Help is not available", actionTitles: ["OK"], actions:[nil])
...
//        emailLabel.text = userAccount?.emailaddress
    ...
    func showSettings() {
        ...
        popupAlert(title: "Settings", message: "Settings is not available", actionTitles: ["OK"], actions:[nil])

    }
    
    func showAccountHome() {
        //TODO - need to implement Home
        popupAlert(title: "Home", message: "Home is not available", actionTitles: ["OK"], actions:[nil])
    }
